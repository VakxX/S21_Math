...
Suite *s21_cos_test() {
  Suite *s;
  TCase *t;
  s = suite_create("\033[45m| s21_cos_test |\033[0m");
  t = tcase_create("s21_cos_test");
  tcase_set_timeout(t, 1000);
  tcase_add_test(t, s21_cos_test_1);
  tcase_add_test(t, s21_cos_test_2);
  tcase_add_test(t, s21_cos_test_3);
  tcase_add_test(t, s21_cos_test_4);
  tcase_add_test(t, s21_cos_test_5);
  tcase_add_test(t, s21_cos_test_6);
  tcase_add_test(t, s21_cos_test_7);
  suite_add_tcase(s, t);
  return s;
}